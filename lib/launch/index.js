...
setups.none = function (manifest, profile, options, callback) {
...
// These have no setup
setups.ie = setups.none
setups.safari = setups.none
...
module.exports = function (manifest, uri, options, callback) {
  ...
  function run (env) {
    ...
    const profile = setup === setups.none ? null : tempy.directory()
    ...
    setup(manifest, profile, options, function (err, args, defaults) {
      ...
      if (process.platform === 'win32') {
        ...
        // TODO: check if still needed (this line is from 2012)
